...
func TestOpenIDConnectExplicitFlowForECDSA(t *testing.T) {
	f := compose.ComposeAllEnabledCommon(new(compose.Config), fositeStore, []byte("some-secret-thats-random-some-secret-thats-random-"), internal.MustECDSAKey())
